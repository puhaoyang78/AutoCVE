...
def get_analysis_config(user_config: dict[str, Any] | None = None) -> dict[str, Any]:
    """
...
async def fetch_file_content(url: str, headers: dict[str, str] = None) -> str | None:
    """获取文件内容"""
    async with httpx.AsyncClient(timeout=30) as client:
        try:

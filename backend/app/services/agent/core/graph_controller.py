...
from .message import MessagePriority, MessageType, message_bus
...
def get_agent_graph(current_agent_id: str | None = None) -> dict[str, Any]:
    """获取Agent图"""
    return agent_graph_controller.get_agent_graph(current_agent_id)


def check_active_agents(exclude_agent_id: str | None = None) -> dict[str, Any]:
    """检查活跃Agent"""
